...
<!--
  AUTO-GENERATED by speckit.plan. Do not edit manually.
  This determines which planning phases are executed.
-->

**Score**: [N] | **Level**: [Full / Standard / Minimal]
...
|----------|------|----------|---------|
| plan.md | ✅ | ✅ | ✅ |
| research.md | ✅ | ⚠ lightweight | ❌ skipped |
...
├── research.md          # Phase 0 output (Full plan only)
├── data-model.md        # Phase 1 output (Full/Standard plan)
├── quickstart.md        # Phase 1 output (Full/Standard plan)
├── contracts/           # Phase 1 output (Full/Standard plan)
